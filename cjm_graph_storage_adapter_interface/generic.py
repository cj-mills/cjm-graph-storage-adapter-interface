"""GenericGraphStorageAdapter — the backend-agnostic graph-storage task implementation: wire-input normalization + forwarding (wire dicts or typed objects in, purely-typed tool arguments, typed results through)."""
